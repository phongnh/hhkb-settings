...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_JP(
        ...
        KC_LCTL,           KC_A,          KC_S,    KC_D,    KC_F,   KC_G,   KC_H,    KC_J,    KC_K,    KC_L,      LT(_MOUSE, KC_SCLN), KC_QUOT, KC_RBRC, KC_ENT,
        KC_LSFT,           KC_Z,          KC_X,    KC_C,    KC_V,   KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,    KC_SLSH,             KC_BSLS, KC_UP,   KC_RSFT,
        LT(_FUNC, KC_GRV), CTL_T(KC_GRV), KC_LALT, KC_LGUI, KC_ENT, KC_SPC, KC_BSPC, KC_RGUI, KC_RALT, MO(_FUNC),                      KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FUNC] = LAYOUT_JP(
